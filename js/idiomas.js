...
//la variable language la genero por php en el index
...
function cambiarIdioma(idioma){
	if(idioma!='es'){	
		...
		if(document.getElementById("botonEnviar")) {document.getElementById("botonEnviar").value="Send";}
		...
		if(document.getElementById("botonEnviar")) {document.getElementById("botonEnviar").value="Enviar";}
		//cambia titulo de la pagina
